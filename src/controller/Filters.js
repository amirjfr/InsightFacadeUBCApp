...
const RoomFilters_1 = require("./RoomFilters");
class Filters {
    constructor() {
        Util_1.default.trace("Filters::init()");
        this.roomFilters = new RoomFilters_1.default();
    }
    processFilters(query, objectKey, id) {
        let that = this;
    ...
    processWildCard(query, objectKey, id, key) {
        let key1 = "";
        let key2 = "";
        switch (key) {
            case id + "_id":
